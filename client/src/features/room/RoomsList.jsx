...
export function RoomsList() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      default: return 'bg-luxury-gray/20 text-luxury-gray border-luxury-gray/30';
    }
  };

  const getRoleDisplay = (room) => {
    if (room.adminId === user?.id) return { text: 'Admin', color: 'text-luxury-gold' };
    if (room.isParticipant) return { text: 'Peserta', color: 'text-luxury-black' };
    return { text: 'Bukan Peserta', color: 'text-luxury-gray' };
  };
      ...
      <div className="min-h-screen bg-gradient-luxury">
        ...
        <div className="pt-20 flex items-center justify-center min-h-screen">
          <div className="text-center animate-fadeInUp">
            ...
            <h3 className="text-xl font-playfair font-semibold text-luxury-black mb-2">Memuat Rooms</h3>
            <p className="text-luxury-gray font-inter">Sedang mengambil data arisan terbaru...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="container-modern">
          <div className="text-center mb-12 animate-fadeInUp">
            <h1 className="text-4xl lg:text-5xl font-playfair font-bold mb-4">
              <span className="gradient-luxury">Dashboard Arisan</span>
            </h1>
            <p className="text-xl text-luxury-gray font-inter max-w-2xl mx-auto">
              Selamat datang kembali, <span className="font-semibold text-luxury-gold">{user?.name}</span>!
        ...
        <div className="w-full max-w-7xl lg:max-w-none mx-auto px-4 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              {/* Action Bar */}
              <div className="card-luxury mb-8 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                  {/* Filters */}
                  <div className="flex flex-wrap gap-3">
                    <div className="flex items-center space-x-2">
                      <svg className="w-5 h-5 text-luxury-gray" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.414A1 1 0 013 6.707V4z" />
                      </svg>
                      <span className="text-sm font-inter font-medium text-luxury-black">Filter:</span>
                    </div>
                    {[
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-inter font-medium transition-all duration-200 ${
                          filter === option.value
                            ...
                            : 'bg-luxury-white/50 text-luxury-gray hover:bg-luxury-white/70 border border-luxury-white/20'
                        }`}
                      >
                        {option.label}
                      </button>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <select
                        ...
                        className="input-luxury text-sm py-2 font-inter"
                      >
                    ...
                    <button
                      ...
                      className="btn-luxury-primary group cursor-pointer"
                    >
              ...
              {filteredRooms.length === 0 ? (
                <div className="text-center py-16 animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
                  <div className="card-luxury max-w-md mx-auto">
                    ...
                    <p className="text-luxury-gray font-inter mb-8">
                      {filter === 'all'
                    ...
                    <button
                      onClick={() => setShowCreateModal(true)}
                      className="btn-luxury-secondary cursor-pointer"
                    >
                      Buat Room Pertama
                    </button>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {filteredRooms.map((room, index) => {
                    ...
                    return (
                      <div
                        key={room.id}
                        className="card-luxury group animate-fadeInUp p-6"
                        style={{ animationDelay: `${index * 0.1}s` }}
                      >
                        {/* Header */}
                        <div className="flex justify-between items-start mb-4">
                          <div className="flex-1 min-w-0">
                            <h3 className="text-xl font-playfair font-semibold text-luxury-black group-hover:text-luxury-gold transition-colors truncate">
                              {room.name}
                            </h3>
                            <p className={`text-sm font-inter font-medium ${role.color} mt-1`}>
                              {role.text}
                            </p>
                          </div>

                          <div className="flex flex-col items-end space-y-2">
                            <span className={`px-3 py-1 text-xs font-inter font-medium rounded-full border ${getStatusColor(room.status)}`}>
                              {room.status === 'waiting' && 'Menunggu'}
                              {room.status === 'ongoing' && 'Berjalan'}
                              {room.status === 'completed' && 'Selesai'}
                            </span>
                            {room.hasPin && (
                              <div className="flex items-center text-xs text-luxury-gray font-inter">
                        ...
                        <div className="mb-4">
                          ...
                          <div className="w-full bg-luxury-gray/20 rounded-full h-2">
                            <div
                              className="bg-gradient-luxury h-2 rounded-full transition-all duration-500"
                        ...
                        <div className="space-y-3 mb-6">
                          <div className="flex items-center justify-between text-sm">
                            <div className="flex items-center space-x-2 text-luxury-gray">
                              ...
                              <span className="font-inter">Iuran</span>
                            </div>
                            <span className="font-semibold text-luxury-black font-inter">
                          ...
                          <div className="flex items-center justify-between text-sm">
                            <div className="flex items-center space-x-2 text-luxury-gray">
                              ...
                              <span className="font-inter">Frekuensi</span>
                            </div>
                            <span className="font-medium text-luxury-black font-inter">
                          ...
                          <div className="flex items-center justify-between text-sm">
                            <div className="flex items-center space-x-2 text-luxury-gray">
                              ...
                              <span className="font-inter">Tenor</span>
                            </div>
                            <span className="font-medium text-luxury-black font-inter">
                        ...
                        <div className="flex gap-3">
                          {room.isParticipant || room.adminId === user?.id ? (
                            <button
                              ...
                              className="flex-1 btn-luxury-primary group cursor-pointer"
                            >
                            ...
                            <>
                              <button
                                ...
                                className={`flex-1 ${
                                  room.participantCount >= room.capacity
                                    ? 'bg-luxury-gray/20 text-luxury-gray cursor-not-allowed border border-luxury-gray/30'
                                    : 'btn-luxury-secondary cursor-pointer'
                                } group`}
                              >
                                {room.participantCount >= room.capacity ? (
                                  <>
                              ...
                              {room.allowSpectator && (
                                <button
                                  onClick={() => handleViewRoom(room.id)}
                                  className="btn-luxury-ghost cursor-pointer group"
                                >
              ...
              <div className="sticky top-24 space-y-6">
                ...
                <div className="card-luxury animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
                  <div className="text-center">
                    <div className="w-16 h-16 bg-gradient-luxury rounded-2xl mx-auto mb-4 flex items-center justify-center">
                    ...
                    <h3 className="text-lg font-playfair font-semibold text-luxury-black mb-1">
                      {user?.name}
                    </h3>
                    <p className="text-sm text-luxury-gray font-inter">
                      Anggota ArisanKu
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  {/* Jumlah Room Saya */}
                  <div className="card-luxury animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-luxury-white/50 rounded-xl flex items-center justify-center">
                      ...
                      <div>
                        <div className="text-2xl font-playfair font-bold gradient-luxury">
                          {rooms.filter(r => r.isParticipant || r.adminId === user?.id).length}
                        </div>
                        <div className="text-sm text-luxury-gray font-inter">Room Saya</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-luxury animate-fadeInUp" style={{ animationDelay: '0.5s' }}>
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-luxury-gray font-inter">Saya Admin</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-luxury animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-luxury-gray font-inter">Sedang Berjalan</div>
                      </div>
                    </div>
                  </div>

                  {/* Total Peserta */}
                  <div className="card-luxury animate-fadeInUp" style={{ animationDelay: '0.7s' }}>
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-luxury-white/50 rounded-xl flex items-center justify-center">
                        <svg className="w-6 h-6 text-luxury-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-luxury-gray font-inter">Total Peserta</div>
                      </div>
                    </div>
                  </div>
                </div>
