...
export function RoomsList() {
  ...
  const getRoleDisplay = (room) => {
    if (room.adminId === user?.id) return { text: 'Admin', color: 'text-coral-600' };
    if (room.isParticipant) return { text: 'Peserta', color: 'text-teal-600' };
    return { text: 'Bukan Peserta', color: 'text-gray-500' };
  };
      ...
      <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-coral-50">
        ...
        <div className="pt-20 flex items-center justify-center min-h-screen">
          <div className="text-center animate-fadeInUp">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Memuat Rooms</h3>
            <p className="text-gray-600">Sedang mengambil data arisan terbaru...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="container-modern">
          <div className="text-center mb-12 animate-fadeInUp">
            <h1 className="text-4xl lg:text-5xl font-bold mb-4">
              <span className="gradient-text">Dashboard Arisan</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Selamat datang kembali, <span className="font-semibold text-teal-600">{user?.name}</span>! 
                  ...
                  >
                    ...
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex-1 min-w-0">
                        <h3 className="text-xl font-semibold text-gray-800 group-hover:text-teal-600 transition-colors truncate">
                          {room.name}
                        </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16">
            <div className="glass-card text-center animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
              <div className="text-2xl font-bold gradient-text mb-1">
                {rooms.filter(r => r.isParticipant || r.adminId === user?.id).length}
              </div>
              <div className="text-sm text-gray-600">Room Saya</div>
            </div>
            <div className="glass-card text-center animate-fadeInUp" style={{ animationDelay: '0.7s' }}>
              <div className="text-2xl font-bold gradient-text mb-1">
                {rooms.filter(r => r.adminId === user?.id).length}
              </div>
              <div className="text-sm text-gray-600">Saya Admin</div>
            </div>
            <div className="glass-card text-center animate-fadeInUp" style={{ animationDelay: '0.8s' }}>
              <div className="text-2xl font-bold gradient-text mb-1">
                {rooms.filter(r => r.status === 'ongoing').length}
              </div>
              <div className="text-sm text-gray-600">Sedang Berjalan</div>
            </div>
            <div className="glass-card text-center animate-fadeInUp" style={{ animationDelay: '0.9s' }}>
              <div className="text-2xl font-bold gradient-text mb-1">
