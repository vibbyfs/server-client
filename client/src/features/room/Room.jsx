...
export default function Room() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-coral-50">
        ...
        <div className="pt-20 flex items-center justify-center min-h-screen">
          <div className="text-center animate-fadeInUp">
            <div className="w-16 h-16 bg-gradient-to-br from-teal-400 to-teal-600 rounded-2xl mx-auto mb-6 flex items-center justify-center animate-pulse">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
              </svg>
            </div>
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Memuat Room</h3>
            <p className="text-gray-600">Sedang mengambil data arisan...</p>
          </div>
        </div>
      </div>
    );
  ...
  const getRoleInfo = () => {
    if (isHost) return { text: 'Admin', color: 'text-coral-600', bgColor: 'bg-coral-100', icon: '👑' };
    if (joinedMode === 'participant') return { text: 'Peserta', color: 'text-teal-600', bgColor: 'bg-teal-100', icon: '👤' };
    if (joinedMode === 'spectator') return { text: 'Penonton', color: 'text-gray-600', bgColor: 'bg-gray-100', icon: '👁️' };
    return { text: 'Visitor', color: 'text-gray-500', bgColor: 'bg-gray-50', icon: '🔍' };
  };
      ...
      <div className="pt-20 pb-8">
        <div className="container-modern">
          ...
          <div className="mb-6 animate-fadeInUp">
            <Link 
              to="/rooms" 
              className="inline-flex items-center text-gray-600 hover:text-teal-600 transition-colors group"
            >
          ...
          {/* Room Header */}
          <div className="glass-card mb-8 animate-fadeInUp" style={{ animationDelay: '0.1s' }}>
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div className="flex-1 min-w-0">
                <div className="flex items-center space-x-3 mb-3">
                  <h1 className="text-3xl font-bold text-gray-800 truncate">{state.room.name}</h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <div className={`font-semibold ${
                      state.room.status === 'waiting' ? 'text-yellow-600' :
                      state.room.status === 'ongoing' ? 'text-green-600' :
                      'text-blue-600'
                    }`}>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              {/* Draw Animation */}
              <div className="card-modern animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800">Animasi Undian</h3>
                </div>
              ...
              {/* Fun Facts */}
              <div className="card-modern animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800">Fun Facts</h3>
                </div>
            ...
            <div className="space-y-8">
              {/* Participants */}
              <div className="card-modern animate-fadeInUp" style={{ animationDelay: '0.5s' }}>
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800">Peserta</h3>
                  <span className="text-sm text-gray-500">({state.participants.length})</span>
                </div>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className={`font-medium truncate ${
                          participant.hasWon ? 'text-green-700 line-through' : 'text-gray-800'
                        }`}>
                          {participant.name}
              ...
              {/* Winners History */}
              <div className="card-modern animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800">Riwayat Pemenang</h3>
                  <span className="text-sm text-gray-500">({state.winners?.length || 0})</span>
                </div>
                ...
                <div className="space-y-3 max-h-80 overflow-y-auto">
                  {state.winners && state.winners.length > 0 ? (
                    state.winners.map((winner, index) => (
                      <div 
                        key={winner.id} 
                        className="flex items-center space-x-3 p-3 glass hover:bg-white/50 rounded-lg transition-all duration-200"
                      >
